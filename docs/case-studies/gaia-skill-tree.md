...
- `https://gaiaskilltree.com/` — genuine public product link; kept as an external link only.
- `https://gaiaskilltree.com/u/mbtiongson1/` — owner profile link from the public README; checked as HTTP 200 on 2026-09-24.
- `https://github.com/gaia-research/gaia-skill-tree` — genuine public source link.
