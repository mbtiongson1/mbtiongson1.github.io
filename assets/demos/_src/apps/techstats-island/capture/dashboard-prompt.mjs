/* GENERATED by tools/sync_shared_modules.py from apps/shared/dashboard-prompt.mjs; edit the source, not this copy. */
...
import { fallbackCopyText } from "./dashboard-export.mjs?v=20260922_1034";
