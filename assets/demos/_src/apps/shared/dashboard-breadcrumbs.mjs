...
export const SUITE_SURFACES = Object.freeze([
  Object.freeze({ id: "exec-overview", label: "Overview", fullTitle: "Executive Overview", route: "/exec" }),
  ...
  Object.freeze({
    ...
    route: "/exec/people",
    tabs: Object.freeze([
      Object.freeze({ id: "pathways", label: "Pathways", question: "Who is becoming ready?", route: "/exec/people" }),
      Object.freeze({ id: "leadership", label: "Leadership", question: "Who carries responsibility now?", route: "/exec/people?tab=leadership" }),
      Object.freeze({ id: "multiplication", label: "Multiplication", question: "Who are those leaders building?", route: "/exec/people?tab=multiplication" }),
    ]),
  }),
  Object.freeze({ id: "connect-field", label: "Connect", fullTitle: "Connect Health", route: "/exec/connect" }),
  Object.freeze({ id: "grow", label: "Grow", fullTitle: "Grow Continuity", route: "/exec/grow" }),
  Object.freeze({ id: "finance", label: "Finance", fullTitle: "Finance Pulse", route: "/exec/finance" }),
  Object.freeze({ id: "events", label: "Events", fullTitle: "Events", route: "/exec/events" }),
  Object.freeze({ id: "sunday-report", label: "Sunday", fullTitle: "Sunday Report", route: "/TechStatsNew" }),
]);
...
export function attachBreadcrumbsInteractions(nav) {
  ...
  // Suppress link navigation if a drag occurred
